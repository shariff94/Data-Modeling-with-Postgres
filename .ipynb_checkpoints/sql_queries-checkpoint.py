...
songplay_table_create = "CREATE TABLE IF NOT EXISTS songplays (songplay_id text PRIMARY KEY, start_time timestamp NOT NULL, user_id text NOT NULL, level text, song_id text, artist_id text, session_id int NOT NULL, location text, user_agent text)"
...
song_table_create = "CREATE TABLE IF NOT EXISTS songs (song_id text NOT NULL PRIMARY KEY, title text, artist_id text, year int, duration float)"
